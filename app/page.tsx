    ...
    <div className="min-h-screen bg-black text-white flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <main className="container mx-auto px-4 pt-2 pb-12 flex flex-col items-center text-center">
          ...
          {/* Replace the "Learn More" button at the bottom with the CountdownTimer */}
          <div className="flex justify-center mb-36">
            <CountdownTimer />
          </div>
        </main>
      </div>
      <footer className="container mx-auto px-4 py-6 flex justify-center gap-6 relative z-10 text-gray-400">
